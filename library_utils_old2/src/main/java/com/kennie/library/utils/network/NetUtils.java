...
public class NetUtils {
    ...
    private static final int NETWORK_TYPE_TD_CDMA = 17;
    private static final int NETWORK_TYPE_WLAN = 18;
    ...
    public static int getNetWorkType() {
        ...
        ConnectivityManager cm = (ConnectivityManager) KennieUtilInit.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//            Log.d("----result---", "result = " + result);
    ...
    public static boolean isWifiEnabled() {
        ConnectivityManager mgrConn = (ConnectivityManager) KennieUtilInit.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        TelephonyManager mgrTel = (TelephonyManager) KennieUtilInit.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) KennieUtilInit.getAppContext()
    ...
    public static boolean isGpsEnabled() {
        LocationManager lm = ((LocationManager) KennieUtilInit.getAppContext().getSystemService(Context.LOCATION_SERVICE));
    ...
    public static void openWirelessSettings() {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.GINGERBREAD_MR1) {
            KennieUtilInit.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        } else {
            KennieUtilInit.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        }
    }
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager tm = (TelephonyManager) KennieUtilInit.getAppContext()
