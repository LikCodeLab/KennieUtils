...
import com.kennie.library.utils.core.IntentUtil;
import com.kennie.library.utils.entity.NotificationInfo;
...
public class NotificationHelper {
    ...
    public static NotificationCompat.Builder getNotificationBuilder(NotificationInfo notificationInfo) {
        NotificationManager notificationManager = (NotificationManager) KennieUtilsApp.getApp().getSystemService(Context.NOTIFICATION_SERVICE);
        NotificationCompat.Builder builder = new NotificationCompat.Builder(KennieUtilsApp.getApp(), notificationInfo.getChannelId());
    ...
    public static boolean isNotificationEnabled() {
        NotificationManagerCompat notificationManager = NotificationManagerCompat.from(KennieUtilsApp.getApp());
    ...
    public static void gotoChannelSetting(String channelId) {
        ...
        intent.putExtra(Settings.EXTRA_APP_PACKAGE, KennieUtilsApp.getApp().getPackageName());
    ...
    public static void gotoNotificationSetting() {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                intent.setAction(Settings.ACTION_APP_NOTIFICATION_SETTINGS);
                intent.putExtra("app_package", KennieUtilsApp.getApp().getPackageName());
                intent.putExtra("app_uid", KennieUtilsApp.getApp().getApplicationInfo().uid);
            } else {
                intent.setAction(Settings.ACTION_APPLICATION_DETAILS_SETTINGS);
                intent.setData(Uri.parse("package:" + KennieUtilsApp.getApp().getPackageName()));
            }
