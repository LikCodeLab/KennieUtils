...
public class RomUtils {
    ...
    public static boolean isRealMeUI(@NonNull Context context) {
        return PhoneSystemUtils.isSystemApp(context, "com.heytap.market");
    }

    public static boolean isOnePlus(@NonNull Context context) {
        return PhoneSystemUtils.isSystemApp(context, "com.oneplus.market");
    }
    ...
    public static String getProp(String name) {
        ...
        try {
            ...
            line = input.readLine();
            Log.d(RomUtils.class.getSimpleName(), "getprop = " + line);
            input.close();
