...
public class AppMarketUtil {
    ...
    public static boolean isMarketAvailable() {
        ...
        List<ResolveInfo> list = KennieUtilsApp.getApp().getPackageManager().queryIntentActivities(intent, 0);
    ...
    public static boolean isInstalledFromGooglePlay() {
        try {
            String installer = KennieUtilsApp.getApp().getPackageManager().getInstallerPackageName(KennieUtilsApp.getApp().getPackageName());
